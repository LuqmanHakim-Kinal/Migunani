    ...
    <div class="container">
        ...
        <form action="/inventaris/{{$inventory->id  }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control"  name="nama" value="{{ $inventory->nama }}" readonly>
            </div>
            <div class="mb-3">
                <label for="tanggal_beli" class="form-label">Tanggal Beli:</label>
                <input type="date" class="form-control" id="tanggal_beli" name="tanggal_beli" value="{{ $inventory->tanggal_pembelian }}" readonly>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-control" id="kondisi" name="kondisi" aria-valuenow="{{ $inventory->kondisi }}">
            ...
            <div class="mb-3">
                ...
                <input type="file" class="form-control" name="files[]" class="form-control-file" multiple>
            </div>
