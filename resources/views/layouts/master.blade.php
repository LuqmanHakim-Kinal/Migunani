        ...
        ***********************************-->
        ...
        <div class="nav-header">
            <div class="brand-logo">
                <a href="index.html">
                    <span class="brand-title" style="color: white; font-size: 24px; font-weight: bold;">Migunani</span>
                    <span class="logo-compact"style="color: white; font-size: 20px; font-weight: bold;">M</span>
                </a>
            </div>
        </div>
        <!--**********************************
